...
def get_argparser():
    ...
    parser.add_argument('--census_data', default='/home/mp2242/safegraph-census/safegraph_open_census_data')
    parser.add_argument('--patterns_data', default='/home/mp2242/safegraph-monthly')
    parser.add_argument('--loans_data', default='/home/mp2242/safegraph-loans')
    parser.add_argument('--n_neighbors', default=3, type=int)
    parser.add_argument('--payroll_data', default='/home/mp2242/financial-contagion/data/business-payroll')
    parser.add_argument('--expenditures_data', default='/home/mp2242/financial-contagion/data/consumer-expenditures')
    ...
    parser.add_argument('--business_assets', default='/home/mp2242/financial-contagion/data/business-assets')
    parser.add_argument('--business_expenses', default='/home/mp2242/financial-contagion/data/business-expenses')
